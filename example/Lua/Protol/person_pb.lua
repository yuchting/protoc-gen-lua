...
PERSON_SEX_FIELD = protobuf.FieldDescriptor();
...
PERSON_SEX_FIELD.name = "sex"
PERSON_SEX_FIELD.full_name = ".Person.sex"
PERSON_SEX_FIELD.number = 4
PERSON_SEX_FIELD.index = 3
PERSON_SEX_FIELD.label = 2
PERSON_SEX_FIELD.has_default_value = false
PERSON_SEX_FIELD.default_value = nil
PERSON_SEX_FIELD.enum_type = common_pb.SEX
PERSON_SEX_FIELD.type = 14
PERSON_SEX_FIELD.cpp_type = 8

PERSON_AGE_FIELD.name = "age"
PERSON_AGE_FIELD.full_name = ".Person.age"
PERSON_AGE_FIELD.number = 5
PERSON_AGE_FIELD.index = 4
...
PERSON_EMAIL_FIELD.number = 6
PERSON_EMAIL_FIELD.index = 5
...
PERSON_ARRAY_FIELD.number = 7
PERSON_ARRAY_FIELD.index = 6
...
PERSON.nested_types = {}
PERSON.enum_types = {}
PERSON.fields = {PERSON_HEADER_FIELD, PERSON_ID_FIELD, PERSON_NAME_FIELD, PERSON_SEX_FIELD, PERSON_AGE_FIELD, PERSON_EMAIL_FIELD, PERSON_ARRAY_FIELD}
